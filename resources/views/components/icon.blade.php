...
@php
    $paths = [
        ...
        // قشرة المعلم والجداول
        'plus'      => '<path d="M12 5v14M5 12h14"/>',
        'trash'     => '<path d="M4 7h16"/><path d="M9.5 7V5.5a1.5 1.5 0 0 1 1.5-1.5h2a1.5 1.5 0 0 1 1.5 1.5V7"/><path d="M6 7v12a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2V7"/><path d="M10 11.5v5M14 11.5v5"/>',
        ...
        'eye-open'  => '<path d="M2.5 12S6 5.5 12 5.5 21.5 12 21.5 12 18 18.5 12 18.5 2.5 12 2.5 12z"/><circle cx="12" cy="12" r="2.75"/>',
        // اتجاهية — تُعكس مع RTL عبر rtl:-scale-x-100 عند الاستدعاء
        'undo'      => '<path d="M9 14 4 9l5-5"/><path d="M4 9h10a6 6 0 0 1 0 12h-3"/>',

        // السطح التحريري — الأخبار
        ...
        'link'      => '<path d="M10.3 13.7a3.9 3.9 0 0 0 5.6 0l2.8-2.8a3.9 3.9 0 1 0-5.6-5.6l-1.6 1.6"/><path d="M13.7 10.3a3.9 3.9 0 0 0-5.6 0l-2.8 2.8a3.9 3.9 0 1 0 5.6 5.6l1.6-1.6"/>',
    ];
@endphp
